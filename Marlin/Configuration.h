 ...
 */
#define PSU_CONTROL
#define PSU_NAME "Power Supply(24v/480w)"
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
//прискорення по осях, від 0 до 1000 і назад
#define DEFAULT_MAX_ACCELERATION      { 1000, 1000, 100, 1000 } //was 1000 1000 2000 2000
 ...
 */
//прискорення під час друку. Воно контролює швидкість зміни швидкості руху по осях 
#define DEFAULT_ACCELERATION          500 //was 1000    // X, Y, Z and E acceleration for printing moves
 //прискорення під час відводу філаменту (ретракції). Під час відводу філаменту принтеру потрібно швидко витягувати філамент назад з екструдера
#define DEFAULT_RETRACT_ACCELERATION  500 //was 1000    // E acceleration for retracts
//прискорення під час переміщення принтера від одного ділянки друку до іншої
#define DEFAULT_TRAVEL_ACCELERATION   1000 //was 1000    // X, Y, Z acceleration for travel (non printing) moves
